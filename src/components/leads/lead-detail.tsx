...
import { logCall, updateLeadNotes } from "@/lib/leads/actions";
...
export async function LeadDetail({
  ...
  // Scoped by product so a Pointly lead can't be opened under /leads
  // (or vice versa) just by pasting its id into the other pipeline's URL.
